...
Version  : 1.29
Release  : 90
URL      : https://cran.r-project.org/src/contrib/knitr_1.29.tar.gz
Source0  : https://cran.r-project.org/src/contrib/knitr_1.29.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592944060
