...
Version  : 1.33
Release  : 99
URL      : https://cran.r-project.org/src/contrib/knitr_1.33.tar.gz
Source0  : https://cran.r-project.org/src/contrib/knitr_1.33.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619275995
