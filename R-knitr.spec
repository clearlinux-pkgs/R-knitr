...
Version  : 1.18
Release  : 47
URL      : https://cran.r-project.org/src/contrib/knitr_1.18.tar.gz
Source0  : https://cran.r-project.org/src/contrib/knitr_1.18.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1514475077
