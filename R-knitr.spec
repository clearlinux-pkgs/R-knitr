...
Version  : 1.36
Release  : 106
URL      : https://cran.r-project.org/src/contrib/knitr_1.36.tar.gz
Source0  : https://cran.r-project.org/src/contrib/knitr_1.36.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632925845
